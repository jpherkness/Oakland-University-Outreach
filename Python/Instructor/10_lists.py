# NOTES: LISTS
# ------------------------------------------------------------------------------
# Lists are used to represent a group of similar or related information.
# The best way to think about a list is to imagine a train where each car
# is a different element of the list.

# CREATING LISTS
# ------------------------------------------------------------------------------
# We create a list using a list of comma separated values between square
# brackets.
L1 = [1, 2, 3, 4, 5]
print("L1 is", L1)
